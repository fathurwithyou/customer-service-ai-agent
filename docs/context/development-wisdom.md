...
The sections that used to follow here were not owner-given rules -- they were lessons derived
while building. They live in [`docs/PRINCIPLES.md`](../PRINCIPLES.md) now, expanded, with the
evidence attached.
